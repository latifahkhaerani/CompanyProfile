...
const Process = () => {
  return (
    <>
      ...
      {/* MOBILE SECTION */}
      <section className="page-wrapper block md:hidden">
        ...
        <div className="flex flex-col md:hidden relative">
          {/* line */}
          <div className="absolute left-10 top-19 bottom-35 w-[2px] bg-gray-300 dark:bg-[#252B37] z-0"></div>
          <div className="pl-5">
            <div className="flex items-start mb-6 relative z-10 ">
              {/* number */}
              <div className="mt-11 flex-1 items-start">
                {steps.map((_, idx) => (
                  <div
                    key={idx}
                    className="mb-20 w-10 h-10 rounded-full bg-[#FF623E] text-white flex items-center justify-center font-bold text-sm"
                  >
                    {idx + 1}
                  </div>
                ))}
